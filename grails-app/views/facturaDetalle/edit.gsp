...
<body>
	<div id="edit-facturaDetalle"
		...
		<g:hasErrors bean="${facturaDetalleInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${facturaDetalleInstance}" var="error">
					<li
		...
		<g:form method="post" class="form-horizontal"
			...
			<g:hiddenField name="version" value="${facturaDetalleInstance?.version}" />
			<fieldset class="form">
